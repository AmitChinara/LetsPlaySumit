...

{
    ...
    steps: [
        ...
        { blank: "Total pens = ___", display: "Total pens = 28", answers: ["28"] },
...

{
    ...
    `,
    steps: [
        { blank: "Boxes = ___", display: "Boxes = 5", answers: ["5"] },
        { blank: "Chocolates per box = ___", display: "Chocolates per box = x", answers: ["x"] },
        { blank: "Total chocolates = ___", display: "Total chocolates = 40", answers: ["40"] },
...

{
    ...
    `,
    steps: [
        { blank: "Packets = ___", display: "Packets = x", answers: ["x"] },
        { blank: "Biscuits per packet = ___", display: "Biscuits per packet = 6", answers: ["6"] },
        { blank: "Total biscuits = ___", display: "Total biscuits = 54", answers: ["54"] },
...

{
    ...
    `,
    steps: [
        { blank: "Bags = ___", display: "Bags = 8", answers: ["8"] },
        { blank: "Oranges per bag = ___", display: "Oranges per bag = x", answers: ["x"] },
        { blank: "Total oranges = ___", display: "Total oranges = 64", answers: ["64"] },
...

{
    ...
    `,
    steps: [
        { blank: "Trays = ___", display: "Trays = x", answers: ["x"] },
        { blank: "Eggs per tray = ___", display: "Eggs per tray = 5", answers: ["5"] },
        { blank: "Total eggs = ___", display: "Total eggs = 35", answers: ["35"] },
...

{
    ...
    `,
    steps: [
        { blank: "Racks = ___", display: "Racks = 9", answers: ["9"] },
        { blank: "Books per rack = ___", display: "Books per rack = x", answers: ["x"] },
        { blank: "Total books = ___", display: "Total books = 81", answers: ["81"] },
...

{
    ...
    `,
    steps: [
        { blank: "Children = ___", display: "Children = x", answers: ["x"] },
        { blank: "Candies per child = ___", display: "Candies per child = 3", answers: ["3"] },
        { blank: "Total candies = ___", display: "Total candies = 24", answers: ["24"] },
...

{
    ...
    `,
    steps: [
        { blank: "Jars = ___", display: "Jars = 4", answers: ["4"] },
        { blank: "Candies per jar = ___", display: "Candies per jar = x", answers: ["x"] },
        { blank: "Total candies = ___", display: "Total candies = 20", answers: ["20"] },
...

{
    ...
    `,
    steps: [
        { blank: "Plates = ___", display: "Plates = x", answers: ["x"] },
        { blank: "Cakes per plate = ___", display: "Cakes per plate = 2", answers: ["2"] },
        { blank: "Total cakes = ___", display: "Total cakes = 16", answers: ["16"] },
...

{
    ...
    `,
    steps: [
        { blank: "Boxes = ___", display: "Boxes = 7", answers: ["7"] },
        { blank: "Toys per box = ___", display: "Toys per box = x", answers: ["x"] },
        { blank: "Total toys = ___", display: "Total toys = 63", answers: ["63"] },
